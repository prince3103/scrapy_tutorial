...
class UserAgentRotatorMiddleware(UserAgentMiddleware):
    user_agent_list = [
        ...
        'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) AppleWebKit/603.3.8 (KHTML, like Gecko) Version/10.1.2Safari/603.3.8',
...
class ScrapTaskSpiderMiddleware:
...
class ScrapTaskDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
